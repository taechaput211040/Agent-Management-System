<template>
  <v-flex>
    <div v-if="!loadingpage">
      <v-btn color="red" @click="$router.go(-1)" dark small class="mx-3"
        >Back</v-btn
      >
        ...
        <div class="ma-3 pb-1 justify-center white rounded-lg classtable">
          ...
          >
            ...
            <template #[`item._id`]="{ item }">
              <span @click="userendering(item.roundId)">
                {{ item.username }}</span
              >
            </template>
            ...
            <template #[`item.memberWin`]="{ item }">
              <div
                class="pa-1 card-detail-transaction rounded-lg  my-2 elevation-2"
              >
                <div
                  class="cursor-pointer"
                  :class="
                    bgFunc(numberFormat(getpercent(item, 6).winLosePayout))
                  "
                >
                ...
                <div
                  :class="
                    bgFunc(
                      numberFormat(getpercent(item, 6).winLosePayout) +
                        getpercent(item, 6).commissionPayout
                    )
                  "
                >
                  ...
                  {{
                    numberFormat(
                      getpercent(item, 6).commissionPayout +
                        getpercent(item, 6).winLosePayout
                    )
                  }}
                </div>
              </div>
            ...
            <template #[`item.agentWin`]="{ item }">
              ...
              >
                <div
                  class="cursor-pointer"
                  :class="
                    bgFunc(numberFormat(getpercent(item, 5).winLosePayout))
                  "
                >
                  <v-chip label x-small color="primary" dark class="px-1"
                    >W/L</v-chip
                ...
                <div
                  :class="
                    bgFunc(
                      numberFormat(getpercent(item, 5).winLosePayout) +
                        getpercent(item, 5).commissionPayout
                    )
                  "
                >
                  <v-chip label x-small color="black" dark class="px-1"
                  ...
                  {{
                    numberFormat(
                      getpercent(item, 5).commissionPayout +
                        getpercent(item, 5).winLosePayout
                    )
                  }}
                </div>
              </div>
            ...
            <template #[`item.seniorWin`]="{ item }">
              ...
              >
                <div
                  class="cursor-pointer"
                  :class="
                    bgFunc(numberFormat(getpercent(item, 4).winLosePayout))
                  "
                >
                  <v-chip label x-small color="primary" dark class="px-1"
                    >W/L</v-chip
            ...
            <template #[`item.shareWin`]="{ item }">
              ...
              >
                <div
                  class="cursor-pointer"
                  :class="
                    bgFunc(numberFormat(getpercent(item, 3).winLosePayout))
                  "
                >
                  <v-chip label x-small color="primary" dark class="px-1"
                    >W/L</v-chip
            ...
            <template #[`item.ownerWin`]="{ item }">
              ...
              >
                <div
                  class="cursor-pointer"
                  :class="
                    bgFunc(numberFormat(getpercent(item, 2).winLosePayout))
                  "
                >
                  <v-chip label x-small color="primary" dark class="px-1"
                    >W/L</v-chip
            ...
            <template #[`item.smartWin`]="{ item }">
              ...
              >
                <div
                  class="cursor-pointer"
                  :class="
                    bgFunc(numberFormat(getpercent(item, 1).winLosePayout))
                  "
                >
                  <v-chip label x-small color="primary" dark class="px-1"
                    >W/L</v-chip
            ...
            <template #[`item.providerwin`]="{ item }">
              ...
              >
                <div
                  class="cursor-pointer"
                  :class="
                    bgFunc(numberFormat(getpercent(item, 0).winLosePayout))
                  "
                >
                  <v-chip label x-small color="primary" dark class="px-1"
                    >W/L</v-chip
      ...
      try {
        ...
        const { data } = await this.getRoundBySenior({
          ...
          username: this.$route.query.username
            ...
            : undefined,
          agent_user: this.$route.query.agent_user
