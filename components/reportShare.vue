  ...
  <v-flex>
    <div v-if="!loadingpage">
      <v-btn
        ...
        >Back</v-btn
      >
      <h2 class="mt-3">Report หุ้นส่วน</h2>
      <template>
          ...
          >
            ...
            <template #[`item.memberWin`]="{ item }">
              <div class="pa-1 rounded-lg card-detail  my-2 elevation-2">
                ...
                <div
                  :class="bgFunc(numberFormat(item.memberCom + item.memberWin))"
                >
            ...
            <template #[`item.agentWin`]="{ item }">
              <div class="pa-1 card-detail rounded-lg  my-2 elevation-2">
                ...
                <div
                  :class="bgFunc(numberFormat(item.agentCom + item.agentWin))"
                >
                  <v-chip label x-small color="black" dark class="px-1"
                    >W/L+com</v-chip
                  >
            ...
            <template #[`item.seniorWin`]="{ item }">
              <div class="pa-1 card-detail rounded-lg  my-2 elevation-2">
                ...
                <div
                  :class="bgFunc(numberFormat(item.seniorCom + item.seniorWin))"
                >
                  <v-chip label x-small color="black" dark class="px-1"
                    >W/L+com</v-chip
                  >
            ...
            <template #[`item.shareWin`]="{ item }">
              <div class="pa-1 card-detail rounded-lg  my-2 elevation-2">
                ...
                <div
                  :class="bgFunc(numberFormat(item.shareCom + item.shareWin))"
                >
                  <v-chip label x-small color="black" dark class="px-1"
                    >W/L+com</v-chip
                  >
            ...
            <template #[`item.ownerWin`]="{ item }">
              <div class="pa-1 card-detail rounded-lg  my-2 elevation-2">
                ...
                <div
                  :class="bgFunc(numberFormat(item.ownerCom + item.ownerWin))"
                >
                  <v-chip label x-small color="black" dark class="px-1"
                    >W/L+com</v-chip
                  >
            ...
            <template #[`item.smartWin`]="{ item }">
              <div class="pa-1 card-detail rounded-lg my-2 elevation-2">
                ...
                <div
                  :class="bgFunc(numberFormat(item.smartCom + item.smartWin))"
                >
                  <v-chip label x-small color="black" dark class="px-1"
                    >W/L+com</v-chip
                  >
...
export default {
  ...
  data() {
    return {
      ...
      isLoading: false,
      itemexam: [{ username: "dsasadsa" }, { bet: "sadsadsad" }],
      headersTable: [
        {
          text: "Username",
          value: "_id",
  ...
  methods: {
    ...
    async renderingMember(user) {
      if (this.role <= 2) {
        console.log(this.$route);
        this.$router.push(`${this.$route.fullPath}&senior_user=${user}`);
      }
      if (this.role == 3) {
        console.log(this.$route);
        this.$router.push(`${this.$route.fullPath}?senior_user=${user}`);
    ...
    ...mapActions("report", ["getAllReport", "getSharebyOwner"]),
    numberWithCommas(x) {
    ...
    async onRequest(props) {
      ...
      try {
        ...
        const { data } = await this.getSharebyOwner({
          ...parameters,
