  ...
  <div>
    ...
    <v-form ref="form" :disabled="$store.state.auth.username !== 'smart'">
      ...
      <div class="mt-3 text-center">
        <v-btn large color="success" @click="dlDetailSetup = true">ตั้งค่าระบบ</v-btn>
      </div>
    </v-form>
    <v-dialog max-width="1400" v-model="dlDetailSetup">
      <v-card class="pa-3">
        <v-card-title primary-title class="justify-center"> รายละเอียดตั้งค่าระบบ </v-card-title>
        <div>
          <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-4">
              System Status
              <v-switch dense hide-details="auto" disabled v-model="form.system_status"></v-switch>
            </div>

            <div class="col-12 col-sm-6 col-md-4">
              Static Hash
              <v-text-field dense hide-details="auto" disabled outlined v-model="form.static_hash"></v-text-field>
            </div>
            <div class="col-12 col-sm-6 col-md-4">
              Provider Hash
              <v-text-field dense hide-details="auto" disabled outlined v-model="form.provider_hash"></v-text-field>
            </div>
            <div class="col-12 col-sm-6 col-md-4">
              Company Name
              <v-text-field dense hide-details="auto" disabled outlined v-model="form.company_name"></v-text-field>
            </div>
            <div class="col-12 col-sm-6 col-md-4">
              Member Link
              <v-text-field dense hide-details="auto" disabled outlined v-model="form.member_link"></v-text-field>
            </div>
            <div class="col-12 col-sm-6 col-md-4">
              Auto Link
              <v-text-field dense hide-details="auto" disabled outlined v-model="form.auto_link"></v-text-field>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
              Company URL
              <v-text-field dense hide-details="auto" disabled outlined v-model="form.companyurl"></v-text-field>
            </div>
            <div class="col-12 col-sm-6 col-md-4">
              Company Line URL
              <v-text-field dense hide-details="auto" disabled outlined v-model="form.companynlineurl"></v-text-field>
            </div>
            <div class="col-12 col-sm-6 col-md-4">
              Company Key
              <v-text-field dense hide-details="auto" disabled outlined v-model="form.companykey"></v-text-field>
            </div>
            <div class="col-12 col-sm-6 col-md-4">
              Lease Withdraw Credit
              <v-text-field dense hide-details="auto" disabled outlined v-model="form.least_wd_credits"></v-text-field>
            </div>
            <div class="col-12 col-sm-6 col-md-4">
              Withdraw Auto Amount
              <v-text-field dense hide-details="auto" disabled outlined v-model="form.wd_auto_amount"></v-text-field>
            </div>
            <div class="col-12 col-sm-6 col-md-4">
              Member Site Name
              <v-text-field dense hide-details="auto" disabled outlined v-model="form.member_site_name"></v-text-field>
            </div>
            <div class="col-12 col-sm-6 col-md-4">
              LOGO URL
              <v-text-field dense hide-details="auto" disabled outlined v-model="form.member_logo_url"></v-text-field>
            </div>
            <div class="col-12 col-sm-6 col-md-4">
              Line Name
              <v-text-field dense hide-details="auto" disabled outlined v-model="form.line_name"></v-text-field>
            </div>
            <div class="col-12 col-sm-6 col-md-4">
              Token
              <v-text-field dense hide-details="auto" disabled outlined v-model="form.token"></v-text-field>
            </div>
            <div class="col-12 col-sm-6 col-md-4">
              Register Link
              <v-text-field dense hide-details="auto" disabled outlined v-model="form.register_link"></v-text-field>
            </div>
            <div class="col-12 col-sm-6 col-md-4">
              Login Link
              <v-text-field dense hide-details="auto" disabled outlined v-model="form.login_link"></v-text-field>
            </div>
            <div class="col-12 col-sm-6 col-md-4">
              Rico ID
              <v-text-field dense hide-details="auto" disabled outlined v-model="form.rico_id"></v-text-field>
            </div>
            <div class="col-12 col-sm-6 col-md-4">
              Hash
              <v-text-field dense hide-details="auto" disabled outlined v-model="form.hash"></v-text-field>
            </div>

            <div class="col-12 col-sm-6 col-md-4">
              เทิร์นเมื่อไม่รับโบนัส
              <v-text-field dense hide-details="auto" disabled outlined v-model="form.turnNobonus"></v-text-field>
            </div>
            <div class="col-12 col-sm-6 col-md-4">
              ถอนออโต้ทั้งระบบ
              <v-switch dense hide-details="auto" disabled outlined v-model="form.wdautoAll"></v-switch>
            </div>
            <div class="col-12 col-sm-6 col-md-4">
              อั้นจำนวนครั้งในการถอนต่อวัน
              <v-text-field dense hide-details="auto" disabled outlined v-model="form.wdlimitTime"></v-text-field>
            </div>
            <div class="col-12 col-sm-6 col-md-4">
              อั้นถอนต่อวัน
              <v-switch dense hide-details="auto" disabled outlined v-model="form.wdlimit"></v-switch>
            </div>
            <div class="col-12 col-sm-6 col-md-4">
              จำนวนเงินที่อั้นถอนต่อวันต่อคน
              <v-text-field dense hide-details="auto" disabled outlined v-model="form.wdlimitcredit"></v-text-field>
            </div>
            <div class="col-12 col-sm-6 col-md-4">
              Withdraw When Outstanding
              <v-switch dense hide-details="auto" disabled outlined v-model="form.wdwhenoutstanding"></v-switch>
            </div>
          </div>
        </div>
        <v-card-actions class="justify-center">
          <v-btn color="success" @click="setUpconfig()" :disabled="$store.state.auth.username !== 'smart'"
            >ตั้งค่าระบบ</v-btn
          >
          <v-btn color="error" @click="dlDetailSetup = false">close</v-btn>
        </v-card-actions>
      </v-card></v-dialog
    >
    <v-dialog max-width="1000" v-model="dlResultSetup">
      <v-card>
          ...
          >
            <div class="row">
              ...
              <div class="col-4" v-for="(obj, j) in item" :key="j">
                ...
                >
                <div v-else-if="obj.p_hash && obj.g_hash">
                  <div>providerhash : {{ obj.p_hash }}</div>
                  <div>gamehash : {{ obj.g_hash }}</div>
                </div>
...
export default {
  ...
  methods: {
    async inputDomain() {
      this.form.companyurl = 'https://' + this.domain
      this.form.member_site_name = 'member.' + this.domain
      this.form.register_link = 'https://member.' + this.domain + '/register'
      this.form.login_link = 'https://member.' + this.domain + '/login'
      this.form.auto_link = 'https://rico.' + this.domain
      this.form.member_link = 'https://member.' + this.domain
    },
    async setUpconfig() {
