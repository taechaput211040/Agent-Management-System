<template>
  <v-flex>
    <div v-if="!isLoading">
      <v-row>
        <v-container>
          <h1 class="text-center mt-2">Senior Management</h1>
          ...
          <v-card class="pa-6">
            ...
            <v-row class="select-item py-2">
              <v-col md="4" cols="12"> <h4 class="px-4">Company Name : sasadsad</h4> </v-col
              ><v-divider vertical></v-divider>
              <v-col md="4" cols="12"> <h4 class="px-4">Owner Name : asdsadsa</h4> </v-col
              ><v-divider vertical></v-divider>
              <v-col md="4" cols="12">
          ...
          <v-card class="pa-2 mt-5 mb-2 classtable">
            <v-row class="ma-4">
              <v-col cols="8"> <h2>Senior Management</h2></v-col>
              <v-col cols="4">
                <v-row align="baseline">
                  ...
                  >
                  <v-col cols="4">
                    <v-btn depressed color="primary" @click="add()"> <v-icon>mdi-plus</v-icon>Add Senior</v-btn></v-col
                  >
                </v-row>
              </v-col>
            </v-row>
            ...
            <v-data-table class="elevation-2 ma-4" :headers="headers" :items="exampleitem" hide-default-footer>
              ...
              <template #[`item.credit`]="{ item, index }">
                ...
                <v-btn depressed color="warning" elevation="2" small @click="showcredit(item.credit, index)"
                  >ตรวจสอบเครดิต</v-btn
                >
              </template>
